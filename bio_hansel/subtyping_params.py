...
class SubtypingParams(object):
    ...
    min_kmer_freq = attr.ib(default=10, validator=attr.validators.instance_of((float, int)))
    max_kmer_freq = attr.ib(default=200, validator=attr.validators.instance_of((float, int)))
