...
class Subtype(object):
    ...
    negative_kmers_matching_subtype = attr.ib(default=None,
                                              validator=attr.validators.optional(attr.validators.instance_of(str)))
    are_subtypes_consistent = attr.ib(default=True, validator=attr.validators.instance_of(bool))
    n_kmers_matching_all = attr.ib(default=0)
    n_kmers_matching_positive = attr.ib(default=0)
    n_kmers_matching_negative = attr.ib(default=0)
    n_kmers_matching_subtype = attr.ib(default=0)
    n_kmers_matching_all_expected = attr.ib(default=0)
    n_kmers_matching_positive_expected = attr.ib(default=0)
    n_kmers_matching_negative_expected = attr.ib(default=0)
    n_kmers_matching_subtype_expected = attr.ib(default=0)
    n_negative_kmers_matching_subtype_expected = attr.ib(default=0)
    avg_kmer_coverage = attr.ib(default=None)
