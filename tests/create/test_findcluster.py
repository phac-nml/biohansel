...
import pandas as pd
import numpy as np
from biohansel.create.find_cluster import find_clusters, compute_distance_matrix, create_linkage_array, output_flat_clusters, cluster_df_to_dict, assign_hc_clusters, expand_sets, row_subtype, df_to_subtypes_dict
...
def test_findcluster():
    ...
    'mysnpsSRR6683914': '1',
    'mysnpsSRR6683916': '1',
    'mysnpsSRR6683917': '2.2',
    'mysnpsSRR6703297': '2.1',
    'mysnpsSRR6967786': '1',
    'mysnpsSRR7128411': '2.1.1.2',
    'mysnpsSRR7128414': '2.1.1.2',
    'mysnpsSRR7130347': '2.1.2',
    'mysnpsSRR7130348': '2.1.1.2',
    'mysnpsSRR7130351': '2.1.1.1',
    'mysnpsSRR7130522': '2.1.1.2',
    'mysnpsSRR7135200': '2.2',
    'mysnpsSRR7167142': '2.1.1.2',
    'mysnpsSRR7168116': '2.1',
    'mysnpsSRR7168670': '2.1.2',
    'mysnpsSRR7170730': '2.1.1.1',
    'mysnpsSRR7221720': '2.1.2'}
...
def test_output_flat_clusters():
 ...
 [4. , 7. , 0.8, 5. ]))
    ...
    test_genomes=['Reference', 'mysnpsSRR6683541', 'mysnpsSRR6683736','mysnpsSRR6683914','mysnpsSRR6683916' ]
    group_size=2
...
def test_assign_hc_clusters():
    test_dict={1: defaultdict(set, {1: {'mysnpsSRR6683914', 'Reference', 'mysnpsSRR6683541', 'mysnpsSRR6683736'}, 2: {'mysnpsSRR6683916'}}), 2: defaultdict(set, {1: {'mysnpsSRR6683914', 'mysnpsSRR6683541', 'mysnpsSRR6683736'}, 2: {'Reference'}, 3: {'mysnpsSRR6683916'}})}
    group_size=2
    expected_result={1: {'1': {'mysnpsSRR6683914', 'Reference', 'mysnpsSRR6683541', 'mysnpsSRR6683736'}, '2': {'mysnpsSRR6683916'}}, 2: {'1': {'mysnpsSRR6683914', 'mysnpsSRR6683541', 'mysnpsSRR6683736'}}}
...
def test_expand_sets():
    test_dict={1: {'1': {'mysnpsSRR6683914', 'Reference', 'mysnpsSRR6683541', 'mysnpsSRR6683736'}, '2': {'mysnpsSRR6683916'}}, 2: {'1': {'mysnpsSRR6683914', 'mysnpsSRR6683541', 'mysnpsSRR6683736'}}}
    expected_result={1: {'Reference': '1', 'mysnpsSRR6683914': '1', 'mysnpsSRR6683541': '1', 'mysnpsSRR6683736': '1', 'mysnpsSRR6683916': '2'}, 2: {'mysnpsSRR6683914': '1', 'mysnpsSRR6683541': '1', 'mysnpsSRR6683736': '1'}}
...
def test_df_to_subtypes_dict():
    ...
    expected_result= {'mysnpsSRR6683541': 1, 'mysnpsSRR6683736': 1, 'mysnpsSRR6683914': 1, 'Reference': 1, 'mysnpsSRR6683916': 2}
