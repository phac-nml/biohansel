...
class SubtypingParams(object):
    low_coverage_threshold = attr.ib(default=20.0, validator=attr.validators.instance_of((float, int)))
    max_missing_tiles = attr.ib(default=0.05, validator=attr.validators.instance_of(float))
    min_ambiguous_tiles = attr.ib(default=3, validator=attr.validators.instance_of(int))
    max_intermediate_tiles = attr.ib(default=0.05, validator=attr.validators.instance_of(float))
    ...
    low_coverage_warning = attr.ib(default=20, validator=attr.validators.instance_of((float, int)))

    @max_missing_tiles.validator
